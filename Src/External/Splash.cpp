// ===========================================================================
// The implementation file for the CSplash class
// ===========================================================================
...
// ===========================================================================
// The following is used for layering support which is used in the splash
// screen for transparency. In VC 6 these are not defined in the headers for
// user32.dll and hence we use mechanisms so that it can work in VC 6. We
// define the flags here and write code so that we can load the function from
// User32.dll explicitely and use it. This code requires Win2k and above
// to work.
// ===========================================================================
...
// ===========================================================================
// The windows procedure that is used to forward messages to the CSplash
// class. CSplash sends the "this" pointer through the CreateWindowEx call
// and the pointer reaches here in the WM_CREATE message. We store
// it here and use it for message forwarding.
// ===========================================================================
...
void CSplash::Init() {
	...
	// Keep the function pointer for the SetLayeredWindowAttributes function in User32.dll ready
...
#endif
	m_hwnd = ::CreateWindowEx(style, m_lpszClassName, TEXT("Banner"), WS_POPUP, x, y, 
