...
namespace Physics {
	...
	*/
	...
	public:
		...
		*/
		IPhysicObj* createObject(Logic::PhysicEntity *component, TPhysicMode mode, 
		...
		*/
		 ...
		 */
		Core::Entity* raycastClosest (const Ray& ray, float maxDist) const; 
		...
		/*
		* Método que comprueba rápidamente si la entidad física pasada como parámetro colisiona o no
		* contra un AABB (Axis Aligned Bounding Box).
		* @param physicObj puntero a la interfaz del objeto físico de la entidad a comprobar.
		* @param center punto central del AABB.
		* @param dim dimensiones que a de tener el AABB.
		* @return Devuelve true si existe colision entre ambas (la entidad esta dentro de la AABB)
		*/
		bool checkHardColision(IPhysicObj* physicObj, const Vector3& center, const Vector3& dim);
