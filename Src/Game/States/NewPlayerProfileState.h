...
#ifndef __GAME_NEWPLAYERPROFILESTATE_H__
#define __GAME_NEWPLAYERPROFILESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la creación de nuevos perfiles de jugador.
	 */
	class NewPlayerProfileState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		NewPlayerProfileState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~NewPlayerProfileState();
	...
	protected:
		...
		/**
		 * El objeto interactivo para introducir el nombre de perfil del jugador.
		 */
		CEGUI::Editbox * _playerName;
