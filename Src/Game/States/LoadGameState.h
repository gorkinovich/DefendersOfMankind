...
#ifndef __GAME_LOADGAMESTATE_H__
#define __GAME_LOADGAMESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de elegir una partida guardada para cargarla.
	 */
	class LoadGameState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		LoadGameState(Core::GenericApplication * application);
	...
	protected:
		...
		/**
		 * El objeto interactivo para seleccionar la partida a cargar.
		 */
		...
		/**
		 * Delegado que gestiona el evento de pulsar el botón "LoadButton".
		 */
