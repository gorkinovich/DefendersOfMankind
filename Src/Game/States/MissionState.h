...
#ifndef __GAME_MISSIONSTATE_H__
#define __GAME_MISSIONSTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de gestionar la ejecución de la misión actual.
	 */
	class MissionState : public Core::ApplicationState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		MissionState(Core::GenericApplication * application);
