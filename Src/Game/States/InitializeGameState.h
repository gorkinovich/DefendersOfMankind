...
#ifndef __GAME_INITIALIZEGAMESTATE_H__
#define __GAME_INITIALIZEGAMESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la inicialización de la partida.
	 */
	class InitializeGameState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		InitializeGameState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~InitializeGameState();
	...
	protected:
		...
		/**
		 * El paso actual dentro del proceso de inicialización.
		 */
		unsigned int _step;
