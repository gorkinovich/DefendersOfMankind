...
#ifndef __GAME_OPTIONSSTATE_H__
#define __GAME_OPTIONSSTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de elegir las opciones del juego.
	 */
	class OptionsState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		OptionsState(Core::GenericApplication * application);
	...
	protected:
		...
		/**
		 * Delegado que gestiona el evento de pulsar el botón "GameplayButton".
		 */
		bool gameplayButton(const CEGUI::EventArgs & e);

		/**
		 * Delegado que gestiona el evento de pulsar el botón "GraphicsButton".
		 */
		bool graphicsButton(const CEGUI::EventArgs & e);

		/**
		 * Delegado que gestiona el evento de pulsar el botón "SoundButton".
		 */
