...
#ifndef __GAME_CHOOSEPLAYERPROFILESTATE_H__
#define __GAME_CHOOSEPLAYERPROFILESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la elección de un perfil de jugador.
	 */
	class ChoosePlayerProfileState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		ChoosePlayerProfileState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~ChoosePlayerProfileState();
	...
	protected:
		...
		/**
		 * El objeto interactivo para seleccionar el perfil a cargar.
		 */
		CEGUI::ItemListbox * _profilesList;
