...
#ifndef __GAME_GAMEPLAYOPTIONSSTATE_H__
#define __GAME_GAMEPLAYOPTIONSSTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de elegir las opciones del gameplay del juego.
	 */
	class GameplayOptionsState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		GameplayOptionsState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~GameplayOptionsState();
