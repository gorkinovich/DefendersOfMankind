...
#ifndef __GAME_RELEASEMISSIONSTATE_H__
#define __GAME_RELEASEMISSIONSTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la finalización de una misión.
	 */
	class ReleaseMissionState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		ReleaseMissionState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~ReleaseMissionState();
