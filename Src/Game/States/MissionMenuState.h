...
#ifndef __GAME_MISSIONMENUSTATE_H__
#define __GAME_MISSIONMENUSTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga del menú de pausa en la misión actual.
	 */
	class MissionMenuState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		MissionMenuState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~MissionMenuState();
