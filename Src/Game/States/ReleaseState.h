...
#ifndef __GAME_RELEASESTATE_H__
#define __GAME_RELEASESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la finalización del juego.
	 */
	class ReleaseState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		ReleaseState(Core::GenericApplication * application);
	...
	protected:
		...
		/**
		 * El paso actual dentro del proceso de finalización.
		 */
		unsigned int _step;
	};
}
