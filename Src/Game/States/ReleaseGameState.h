...
#ifndef __GAME_RELEASEGAMESTATE_H__
#define __GAME_RELEASEGAMESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la finalización de la partida.
	 */
	class ReleaseGameState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		ReleaseGameState(Core::GenericApplication * application);

		/**
		 * Destructor del objeto.
		 */
		virtual ~ReleaseGameState();
