...
#ifndef __GAME_INITIALIZESTATE_H__
#define __GAME_INITIALIZESTATE_H__
...
namespace Game {
	/**
	 * Esta clase representa el estado que se encarga de la inicialización del juego.
	 */
	class InitializeState : public Game::GenericMenuState {
	public:
		//----------------------------------------------------------------------------------------------------
		// Constantes
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		InitializeState(Core::GenericApplication * application);
