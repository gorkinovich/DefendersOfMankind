...
namespace Logic {
	/**
	 * Esta clase representa un mensaje para indicar contra qué entidad se ha colisionado o dejado de colisionar.
	 */
	...
	public:
		...
		/**
		 * Obtiene la entidad víctima de la colisión.
		 */
	...
	protected:
		...
		/**
		 * La entidad víctima de la colisión.
		 */
		Core::Entity * _victim;
