...
#ifndef __LOGIC_MOVETOMESSAGE_H__
#define __LOGIC_MOVETOMESSAGE_H__
...
namespace Logic {
	/**
	 * Esta clase representa un mensaje para indicar el destino final del movimiento.
	 */
	class MoveToMessage : public Core::Object {
	public:
		//----------------------------------------------------------------------------------------------------
		// Propiedades
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		inline int getMoveType() const { return _moveType; }
		 ...
		 */
		MoveToMessage(int moveType, const Vector3 & target);
		
		/**
		 * Constructor copia del objeto.
		 * @param obj El objeto a copiar.
		 */
		MoveToMessage(const MoveToMessage & obj);
