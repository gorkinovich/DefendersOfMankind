...
namespace Logic {
	/**
	 * Esta clase representa un mensaje para infligir daño a una entidad.
	 */
	...
	public:
		...
		/**
		 * Obtiene la cantidad de daño infligido.
		 */
		 ...
		 * @param damageTarget El tipo del objetivo del daño.
		 */
