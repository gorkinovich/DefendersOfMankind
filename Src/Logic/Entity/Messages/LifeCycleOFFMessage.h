...
#ifndef __LOGIC_LIFECYCLEOFFMESSAGE_H__
#define __LOGIC_LIFECYCLEOFFMESSAGE_H__
...
namespace Logic {
	 ...
	 */
	class LifeCycleOFFMessage : public Core::Object {
	public:
		//----------------------------------------------------------------------------------------------------
		// Propiedades
		//----------------------------------------------------------------------------------------------------
		 ...
		 */
		LifeCycleOFFMessage(const LifeCycleOFFMessage & obj);
		
		/**
		 * Destructor del objeto.
		 */
		virtual ~LifeCycleOFFMessage();
