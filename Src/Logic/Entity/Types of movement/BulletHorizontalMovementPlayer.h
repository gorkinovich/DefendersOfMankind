...
#ifndef __LOGIC_BULLETHORIZONTALMOVEMENTPLAYER_H__
#define __LOGIC_BULLETHORIZONTALMOVEMENTPLAYER_H__
...
namespace Logic {
	...
	/**
	 * Esta clase representa el tipo de movimiento horizontal para las balas del jugador.
	 */
	class BulletHorizontalMovementPlayer: public IMovement
	{
	public:
		MovementCreateMethod(BulletHorizontalMovementPlayer);

		/**
		Constructor por defecto.
		*/
		BulletHorizontalMovementPlayer() : IMovement("BulletHorizontalMovementPlayer"), _vel(0.0f) {}
...
#endif	// __LOGIC_BULLETHORIZONTALMOVEMENTPLAYER_H__
