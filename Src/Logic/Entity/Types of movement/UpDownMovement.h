...
#ifndef __LOGIC_UPDOWNMOVEMENT_H__
#define __LOGIC_UPDOWNMOVEMENT_H__
...
namespace Logic {
	...
	/**
	 * Esta clase representa el tipo de movimiento arriba-abajo.
	 */
	...
	class UpDownMovement: public IMovement
	{
	public:
		MovementCreateMethod(UpDownMovement);

		/**
		Constructor por defecto.
		*/
		UpDownMovement() : IMovement("UpDownMovement"), _vel(0.0f), _maxDistance(0.0f), _direction(UP_LEFT),
							_staticOffset(0.0f), _approachVel(0.0f) {}
...
#endif	// __LOGIC_UPDOWNMOVEMENT_H__
