...
#ifndef __LOGIC_SINUSOIDALMOVEMENT_H__
#define __LOGIC_SINUSOIDALMOVEMENT_H__
...
namespace Logic {
	...
	/**
	 * Esta clase representa el tipo de movimiento sinusoidal.
	 */
	class SinusoidalMovement: public IMovement
	{
	public:
		MovementCreateMethod(SinusoidalMovement);

		/**
		Constructor por defecto.
		*/
		SinusoidalMovement() : IMovement("SinusoidalMovement"), _vel(0.0f), _degrees(0.0f),
				_amplitudeWave(0.0f), _centerWave(0.0f), _offset(0.0f), _degreesVel(0.0f) {}
...
#endif	// __LOGIC_SINUSOIDALMOVEMENT_H__
