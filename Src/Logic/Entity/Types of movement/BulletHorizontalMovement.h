...
#ifndef __LOGIC_BULLETHORIZONTALMOVEMENT_H__
#define __LOGIC_BULLETHORIZONTALMOVEMENT_H__
...
namespace Logic {
	...
	/**
	 * Esta clase representa el tipo de movimiento horizontal para las balas de los enemigos.
	 */
	class BulletHorizontalMovement: public IMovement
	{
	public:
		MovementCreateMethod(BulletHorizontalMovement);

		/**
		Constructor por defecto.
		*/
		BulletHorizontalMovement() : IMovement("BulletHorizontalMovement"), _vel(0.0f) {}
...
#endif	// __LOGIC_BULLETHORIZONTALMOVEMENT_H__
