...
#ifndef __LOGIC_HORIZONTALMOVEMENT_H__
#define __LOGIC_HORIZONTALMOVEMENT_H__
...
namespace Logic {
	...
	/**
	 * Esta clase representa el tipo de movimiento horizontal.
	 */
	class HorizontalMovement: public IMovement
	{
	public:
		MovementCreateMethod(HorizontalMovement);

		/**
		Constructor por defecto.
		*/
		HorizontalMovement() : IMovement("HorizontalMovement"), _vel(0.0f) {}
...
#endif	// __LOGIC_HORIZONTALMOVEMENT_H__
