...
namespace Core {
	...
	/**
	 * Este tipo representa una tabla de entidades en base a su identificador único.
	 */
	...
	/**
	 * Este tipo representa un iterador de una tabla de entidades en base a su identificador único.
	 */
