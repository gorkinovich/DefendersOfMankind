...
#ifndef __CORE_INFOTABLEUTILS_H__
#define __CORE_INFOTABLEUTILS_H__
...
namespace Core {
	...
	/**
	 * Convierte una variable global de la máquina virtual de Lua en una InfoTable.
	 * @param name El nombre de la variable global.
	 * @return Devuelve si todo ha ido correctamente la nueva InfoTable con la información obtenida,
