...
namespace Core {
	...
	public:
		 ...
		 * @param name El nombre del componente.
		 * @return El valor del componente, si no existe devuelve una excepción.
		 */
	...
	protected:
		...
		/**
		 * Flag para comprobar si el conjunto de nombres de los componentes está desactualizado.
		 */
		 ...
		 * @return Devuelve true si logra hacer la partición de forma correcta.
		 */
