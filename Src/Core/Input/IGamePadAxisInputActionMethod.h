...
#ifndef __CORE_IGAMEPADAXISINPUTACTIONMETHOD_H__
#define __CORE_IGAMEPADAXISINPUTACTIONMETHOD_H__
...
namespace Core {
	...
	public:
		 ...
		 */
		virtual void gamePadAxisInputChanged(const GamePadAxisInputItem & item) = 0;
		 ...
		 */
		virtual ~IGamePadAxisInputActionMethod() {}
