...
#ifndef __CORE_IMOUSEBUTTONINPUTACTIONMETHOD_H__
#define __CORE_IMOUSEBUTTONINPUTACTIONMETHOD_H__
...
namespace Core {
	...
	public:
		 ...
		 */
		virtual void mouseButtonInputChanged(const MouseButtonInputItem & item) = 0;
		 ...
		 */
		virtual ~IMouseButtonInputActionMethod() {}
