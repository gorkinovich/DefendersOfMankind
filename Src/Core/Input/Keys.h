...
#ifndef __CORE_KEYS_H__
#define __CORE_KEYS_H__
...
namespace Core {
	namespace Key {
		/**
		 * Esta enumeración representa una tecla del teclado.
		 * AVISO: Los valores están copiados de OIS::KeyCode.
		 */
		enum KeyCode {
			KEY_UNASSIGNED   = 0x00,
			KEY_ESCAPE       = 0x01,
			...
			KEY_PREVTRACK    = 0x90,    // Previous Track (CIRCUMFLEX on Japanese keyboard)
	...
	/**
	 * Este tipo representa una tecla del teclado.
	 */
	typedef Key::KeyCode KeyCode;

	namespace Modifier {
		/**
		 * Esta enumeración representa un modificador del teclado.
		 * AVISO: Los valores están copiados de OIS::Keyboard::Modifier.
		 */
		enum ModifierCode {
			SHIFT = 0x0000001,
			CTRL  = 0x0000010,
	...
	/**
	 * Este tipo representa un modificador del teclado.
	 */
	typedef Modifier::ModifierCode ModifierCode;
}
